...
# ==========================
slow_factor = 1.0      # Fattore di rallentamento per il CSV
dt = 0.1               # Passo temporale

# Output CSV
OUTPUT_DIR = "./CSV_Files"
os.makedirs(OUTPUT_DIR, exist_ok=True)
OUTPUT_CSV = os.path.join(OUTPUT_DIR, "linear.csv")
...
def trajectory():
    ...
    # Calcolo yaw
    # Convenzione: yaw_line = heading - π/2
    p0 = waypoints[0]
    p1 = waypoints[1]
    d = p1[:2] - p0[:2]
...
times = np.arange(0.0, t_end_nominal * slow_factor + 1e-9, dt)
